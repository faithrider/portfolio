...
export const solimoesPhotos: AmazoniaPhoto[] = [
  ...
  { id: 's2', image: '/amazonia/BRAZIL-SOLIMOES-canoe.jpg', caption: 'Mud clings to a canoe pulled onto the bank, settling as the water’s motion slows. The rise and fall of the river shifts the boundary between river and land, wherein sediment is deposited and disturbed with each change in level. Surfaces retain these traces, showing recent interaction with the river.', device: 'Nikon Z5, 50-250mm', date: '8:38AM | 14 March 2026' },
  ...
  { id: 's4', image: '/amazonia/BRAZIL-SOLIMOES-oar.jpg', caption: 'A painted oar, chipped from use, rests within reach. Motors handle most of the work on the main channel, but in shallower areas where depth can change dramatically over just a few meters, a paddle offers more precise control. The paint is worn down where the hand grips it, and where it makes contact with the water.', device: 'Nikon Z5, 50-250mm', date: '7:17AM | 14 March 2026' },
...
export const negroPhotos: AmazoniaPhoto[] = [
  ...
  { id: 'n6', image: '/amazonia/BRAZIL-NEGRO-leafrain.jpg', caption: 'Rainfall collects and moves across leaf surfaces before returning to the ground and water below. Precipitation in the Amazon basin feeds back into the river system almost immediately. The forest recycles a significant share of its own moisture through evaporation, which in turn generates the rainfall that sustains the river.', device: 'Nikon Z5, 50-250mm', date: '4:19PM | 18 March 2026' },
